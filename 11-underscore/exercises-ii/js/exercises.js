...
const allLongWords = _(words).every(function (word) {
  return word.length > 3;
});
console.log( allLongWords );

// Check if some words are over twenty characters long
const someSuperLongWords = _(words).some(function (word) {
  return word.length > 20;
});
console.log( someSuperLongWords );
...
const counts = _(numbers).countBy(function (n) {
